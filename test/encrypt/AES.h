...
*/
  ...
  */
   ...
   */
  void do_aes_encrypt(byte *plain,int size_p,byte *cipher,byte *ret, int bits, byte ivl [N_BLOCK]);
   ...
   * @note The key will be stored in class variable.
   */
  void do_aes_encrypt(byte *plain,int size_p,byte *cipher,byte *ret, int bits);
   ...
   * @note The key will be stored in class variable.
   */
  void do_aes_decrypt(byte *cipher,int size_c,byte *plain,byte *ret, int bits, byte ivl [N_BLOCK]);
   ...
   * @note The key will be stored in class variable.
   */
  void do_aes_decrypt(byte *cipher,int size_c,byte *plain,byte *ret, int bits);
